              ...
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    ...
                    @click="$router.push({name:'master-jenis-rambu',params:{ itemsPerPage: $route.params.itemsPerPage, page: $route.params.page} })"
      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Pengisian Data Rambu
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl:
        "api/superadmin/master-data/rambu/" +
        this.$route.params.jenis_rambu_uuid,
      pagination: false,
      title: "MASTER RAMBU",
      subtitle: "Berikut Daftar Seluruh Rambu Yang Tersedia",
      breadcrumbs: [
        {
          text: "Data Master",
          disabled: false,
  ...
  methods: {
    ...
    uploadFile: function () {
      this.assignFileBrowse({
        ...
        callback: (response) => {
          setTimeout(() => {
            this.icon = response.name;
            this.record.icon = response.name;
            this.snackbar.color = this.theme.color;
            this.snackbar.text = "Proses upload icon berhasil";
