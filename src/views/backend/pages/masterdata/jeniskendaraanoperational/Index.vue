      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Jenis Kendaraan
          </v-toolbar>
...
export default {
  name: "jenis-kendaraan-operational",
  data: () => ({
    num: 1,
    headers: [
      {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/jenis-kendaraan-operational",
      pagination: false,
      key: "id",
      title: "MASTER JENIS KENDARAAN OPERATIONAL",
      subtitle: "Berikut Daftar Seluruh Jenis Kendaraan Yang Tersedia",
      breadcrumbs: [
        {
          text: "Data Master",
          disabled: false,
