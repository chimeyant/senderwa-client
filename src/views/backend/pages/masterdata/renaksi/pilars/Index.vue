      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Pilar
          </v-toolbar>
          <v-card-text class="mt-2">
            ...
            <v-col col="12">
              <v-textarea
                ...
                placeholder="Penjelasan dari pilar"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/pilar",
      pagination: false,
      title: "RENAKSI (PILAR)",
      subtitle: "Berikut Daftar Seluruh Pilar Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
