            ...
            >
              <template v-slot:activator="{ on }">
                <v-btn
                  ...
                  icon
                  v-on="on"
                  @click="$router.push({name:'master-pilar'})"
                >
          ...
          >
            ...
            <template v-slot:item.id="{ value }">
              ...
              >
                ...
                <v-list>
                  <v-list-item @click="openKegiatan(value)">
                    <v-list-item-title>
                ...
                <template v-slot:default="{ active }">
                  ...
                  <v-list-item-action>
                    ...
                    >
                      ...
                      <v-list>
                        <v-list-item @click="openKegiatan(item.id)">
                          <v-list-item-title>
                            <v-icon :color="theme.color">mdi-clipboard-list</v-icon>
                            Atur Kegiatan
                          </v-list-item-title>
      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Program
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl:
        "api/superadmin/master-data/program/" + this.$route.params.pilar_uuid,
      pagination: false,
      title: "RENAKSI (PROGRAM)",
      subtitle: "Berikut Daftar Seluruh Program Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
  ...
  methods: {
    ...
    openKegiatan: function (val) {
      this.$router.push({
        name: "master-kegiatan",
        params: {
          pilar_uuid: this.$route.params.pilar_uuid,
          program_uuid: val,
        },
      });
    },
