      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Jenis Kegiatan
          </v-toolbar>
          <v-card-text class="mt-2">
            ...
            <v-col col="12">
              <v-text-field
                ...
                :hide-details="device.desktop"
                label="Keterangan"
                placeholder="Penjelasan singkat jenis kegiatan"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/jenis-kegiatan",
      pagination: false,
      title: "MASTER JENIS KEGIATAN",
      subtitle: "Berikut Daftar Seluruh Jenis Kegiatan Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
