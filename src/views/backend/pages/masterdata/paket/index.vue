      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Paket Harga
          </v-toolbar>
          <v-card-text class="mt-2">
            <v-col col="12">
              <v-text-field
                ...
                label="Nama Paket"
                placeholder="Masukan Nama Paket Yang Anda Inginkan"
                v-model="record.name"
                :filled="record.name"
                dense
              ></v-text-field>
            ...
            <v-col col="12">
              <v-text-field
                ...
                :hide-details="device.desktop"
                label="Keterangan"
                placeholder="Pejelasan tentang paket"
            ...
            <v-col col="12">
              <v-text-field
                ...
                :hide-details="device.desktop"
                label="Harga Paket"
                placeholder="Masukan Harga Paket Tanpa Koma atau Titik"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/paket",
      pagination: false,
      title: "MASTER PAKET HARGA",
      subtitle: "Berikut Daftar Seluruh Paket Harga Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
