      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Team
          </v-toolbar>
          <v-card-text class="mt-2">
            ...
            <v-col col="12">
              <v-text-field
                ...
                :hide-details="device.desktop"
                label="Keterangan"
                placeholder="Maukan keterangan mengenai team"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/teams",
      pagination: false,
      title: "MASTER TEAM",
      subtitle: "Berikut Daftar Seluruh Team Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
