      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Kontak
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/master-data/contact",
      pagination: false,
      title: "MASTER KONTAK",
      subtitle: "Berikut Daftar Seluruh Kontak Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
