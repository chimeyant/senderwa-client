      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Sekolah
          </v-toolbar>
          <v-card-text class="mt-2">
            <v-col cols="12">
              <v-select
                ...
                dense
                hide-details
                v-model="record.sekolah_tingkat_uuid"
                :items="tingkats"
              ></v-select>
            </v-col>
            <v-col col="12">
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/sekolah",
      pagination: false,
      title: "MASTER SEKOLAH",
      subtitle: "Berikut Daftar Seluruh Sekolah Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
