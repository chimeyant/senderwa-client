      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Jenis Pengaduan
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/jenis-pengaduan",
      pagination: false,
      key: "id",
      title: "MASTER JENIS PENGADUAN",
      subtitle: "Berikut Daftar Seluruh Jenis Pengaduan Yang Tersedia",
      breadcrumbs: [
        {
          text: "Data Master",
          disabled: false,
